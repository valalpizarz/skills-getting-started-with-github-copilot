...
activities = {
    ...
    "Track Team": {
        "description": "Train for running events, relays, and field competitions",
    ...
    "Drama Club": {
        "description": "Act, perform, and develop stage presence in theater productions",
        "schedule": "Thursdays, 3:30 PM - 5:30 PM",
        "max_participants": 14,
        "participants": ["isabella@mergington.edu", "lucas@mergington.edu"]
    },
    "Robotics Club": {
        "description": "Build robots and solve engineering challenges as a team",
